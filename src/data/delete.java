...
public class delete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ENTER NAME WHICH YOU");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 0, 51));
        jLabel2.setText(" WANT TO DELETE");
    ...
    Connection con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/data","root","");  // connection
        ...
        PreparedStatement ps = (PreparedStatement) con.prepareStatement("delete from data1 where name=?");
        ps.setString(1, name);
